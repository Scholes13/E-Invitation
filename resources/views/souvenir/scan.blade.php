...
<title>Souvenir Claim Scanner - {{ mySetting()->name_app != '' ? mySetting()->name_app : env('APP_NAME') }}</title>
...
<div class="container pt-5">
    <div class="form-group mt-5">
        <h2 class="text-light text-center scan-title">Souvenir Claim Scanner</h2>
...
<script>
    $(document).ready(function() {
        ...
        const SCAN_HISTORY_KEY = 'souvenir_scan_history';
        ...
        function processQRCode(qrCode) {
            console.log("Processing QR code for souvenir claim:", qrCode);
        ...
        function takePictureAndSubmit(qrCode) {
            try {
                ...
                const url = "{{ route('souvenir.process') }}";
